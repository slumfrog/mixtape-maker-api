class MixtapesController < ApplicationController
    ...
    def create
        ...
        mixtape_params[:tracks].map{|track| track = Track.create(name: track[:name], artist: track[:artist], comment: track[:comment], duration: track[:duration], preview: track[:preview], track_id: track[:track_id])}
        render json: mixtape
    end
